<template>
    <div class="">
        <div class="m-portlet m-portlet--creative m-portlet--rounded m-portlet--bordered-semi m-portlet--bordered ">
            <div class="m-portlet__body">
                        ...
                        <div class="row">
                            <div class="row">
                                ...
                                <div style="text-align: right;" class="col-md-6">
                                    ...
                                    <router-link v-if="routeCreate" :to="{name: `${routeCreate}.create`}"
                ...
                <template v-else>
                    ...
                    <div v-else class="d-flex flex-column align-items-center my-4">
                        <svg xmlns="http://www.w3.org/2000/svg" data-name="Not found" class="col-8 col-sm-3 col-lg-4"
                             viewBox="0 0 709.53268 558.59384" xmlns:xlink="http://www.w3.org/1999/xlink">
                            ...
                            <!--<rect width="643.86163" height="27.3536" fill="#205888"/><circle cx="20.327" cy="13.98461" r="5.06978" fill="#fff"/><circle cx="39.57061" cy="13.98461" r="5.06978" fill="#fff"/><circle cx="58.81422" cy="13.98461" r="5.06978" fill="#fff"/>-->
                            <rect x="73.84385" y="86.97284" width="155.98055" height="266.46677" fill="#e6e6e6"/>
                            <rect x="256.7496" y="86.97284" width="129.9838" height="73.34799" fill="#205888"/>
                            ...
                            <path
                                ...
                                transform="translate(-245.23366 -170.70308)" fill="#205888"/>
                            <path
...
export default {
    name: "CardTable",
    components: {Skeleton, SubHeader, Table},
    computed: {
        limit() {
            return this.windowWidth > 830
                ? 15
                : (this.windowWidth < 700 ? 3 : 10)
        }
    },
    data: () => ({
        isLoaded: false,

<template xmlns="http://www.w3.org/1999/html">
    <div class="col-sm-12 col-md-12 col-lg-12">
        <section>
            <sub-header :links="subHeaderLinks" :module="'Alunos'" :title="'Alunos'"></sub-header>
                        ...
                        <CardTable
                            ...
                            <template v-slot:header-card>
                                <div class="col-md-6">
                                    ...
                                    <h6 class="card-subtitle text-muted">Utilize o módulo para ver os alunos cadastrados ou então editar e excluí-los.</h6>
                                </div>
                            </template>
    ...
    methods: {
        updateStatus(item){
            ...
            Swal.fire({
                icon: 'question',
                title: 'Confirmação',
                html: ('Deseja realmente alterar o status do aluno ' + item.usuario.nome + ' para ' + (ativo ? 'ativo' : 'inativo') + '?'),
                ...
                preConfirm: () => {
                    return new Promise(() => {
                        me.isLoading = true;
                        toSeek(route('admin.aluno.active', {'aluno': item.id, 'active': ativo})).then(
                            data => {
                                if(data.success){

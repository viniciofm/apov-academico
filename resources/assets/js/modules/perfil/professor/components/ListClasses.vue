<template xmlns="http://www.w3.org/1999/html">
    <div class="col-sm-12 col-md-12 col-lg-12">
        <section v-if="turma_disciplina">
            <sub-header :links="subHeaderLinks" :module="'Aulas'" :title="'Aulas'"></sub-header>
                                    ...
                                    <td scope="col" class="text-center">
                                        <div class="row">
                                            ...
                                            <button v-can="'can-update'" v-on:click="remover(item)"
                                                    class="btn col-md-3" :title="'Remover aula'">
    ...
    methods: {
        ...
        remover(item){
            ...
            Swal.fire({
                icon: 'question',
                title: 'Confirmação',
                html: ('Deseja realmente remover a aula para a disciplina ' + me.turma_disciplina.disciplina.sigla + '?'),
                ...
                preConfirm: () => {
                    return new Promise(() => {
                        me.isLoading = true;
                        submit(route('content.aula.delete'), {'id': item.id}, 'DELETE').then(
                            data => {
                                if(data.success){

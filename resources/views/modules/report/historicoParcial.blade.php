...
@section('content')
    <div>
        <div class="col-sm-12 col-md-12 col-lg-12">
            @include('components.sub-header', array('links' => [], 'module' => 'Relatório', 'title' => 'Histórico Parcial'))

            <div class="card mb-3">
                <div class="card-body">
                    <div class="row">
                        <div style="text-align: right;" class="col-md-12">
                            <a target="_blank" href="{{ route('relatorio.pdf.historico-parcial', $matricula)  }}"

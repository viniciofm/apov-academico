...
Route::prefix('admin/turma')->name('admin.turma.')->middleware(['auth'])->group(function() {
    ...
    Route::delete('/delete', 'TurmaController@delete')->name('delete');
    ...
    Route::prefix('disciplina')->name('disciplina.')->group(function () {
        ...
        Route::get('/active/{turmaDisciplina}/{active}', 'TurmaDisciplinaController@active')->name('active');
    });
});
...
Route::prefix('relatorio')->name('relatorio.')->middleware(['auth'])->group(function() {
    ...
    Route::get('boletim/{matricula}', 'ReportController@boletim')->name('boletim');
    ...
    Route::prefix('pdf')->name('pdf.')->group(function (){
        ...
        Route::get('boletim/{matricula}', 'ReportPdfController@boletim')->name('boletim');

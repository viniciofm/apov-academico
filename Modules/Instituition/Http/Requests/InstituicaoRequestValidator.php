...
namespace Modules\Instituition\Http\Requests;


use App\Http\Requests\AbstractGenericFormRequest;
use Illuminate\Support\Facades\Auth;

class InstituicaoRequestValidator extends AbstractGenericFormRequest
{
    /**
    ...
    {
        return [
            'id' => 'sometimes|required|uuid|exists:instituicao,id',
            'nome' => 'required|string',
            'email' => 'required|email|string',
            'responsavel' => 'required|string',
            'responsavel_cargo' => 'required|string',
            'telefone_contato' => 'string|nullable',
            'cpf_cnpj' => 'required|string',
            'tipo_documento' => 'required|string',
            'logomarca' => 'mimes:jpeg,png,jpg|max:2048',
            'logomarca_secundaria' => 'mimes:jpeg,png,jpg|max:2048',
            'endereco' => 'array',
    ...
    public function attributes()
    {
        return [
            ...
            'logomarca' => 'Logomarca',
            'logomarca_secundaria' => 'Logomarca Auxiliar',
            'endereco' => 'Endereço',
